...
export default function Page() {
  ...
  return (
    <Box>
      <AppBar position="sticky" variant='elevation' color='primary' sx={{ boxShadow: 'none', borderBottom: '1px solid #E0E0E0', zIndex: 1000 }}>
        <Tabs value={v} onChange={handleChange} indicatorColor="primary" textColor="inherit" variant="fullWidth" aria-label="Page-tabs">
          <Tab label={"VIAGENS"} sx={{ fontSize: '1rem', fontWeight: 'bold',color:"#fff" }} />
          <Tab label={"INSPEÇÕES"} sx={{ fontSize: '1rem', fontWeight: 'bold',color:"#fff" }} />
        </Tabs>
      </AppBar>
